...
namespace ValidarCorreo {
    ...
    public partial class UsersDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(string Nick, string Password) {
        ...
        public partial class UsersRow : global::System.Data.DataRow {
            ...
            public string Nick {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Nick\' de la tabla \'Users\' es DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsNickNull() {
                return this.IsNull(this.tableUsers.NickColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetNickNull() {
                this[this.tableUsers.NickColumn] = global::System.Convert.DBNull;
            }
...
namespace ValidarCorreo.UsersDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Users` WHERE ((`Id` = ?) AND ((? = 1 AND `Nick` IS NULL) OR (`Nick` " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Users` (`Nick`, `Password`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Users` SET `Nick` = ?, `Password` = ? WHERE ((`Id` = ?) AND ((? = 1 AND `" +
                "Nick` IS NULL) OR (`Nick` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Passwor" +
                "d` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ValidarCorreo.Properties.Settings.Default.UsersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nick, [Password] FROM Users";
        ...
        public virtual int Delete(int Original_Id, string Original_Nick, string Original_Password) {
        ...
        public virtual int Insert(string Nick, string Password) {
            if ((Nick == null)) {
        ...
        public virtual int Update(string Nick, string Password, int Original_Id, string Original_Nick, string Original_Password) {
            if ((Nick == null)) {
